    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative">
      ...
      <div className="relative z-20 w-full max-w-md px-6">
        <div className="glass-strong rounded-xl p-8">
          ...
          <h1 className="text-2xl font-bold font-display text-center mb-6">Welcome back</h1>
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div>
              <label className="text-sm text-muted-foreground block mb-1.5">Email</label>
              <Input type="email" placeholder="you@organization.com" className="bg-muted/50 border-border focus:ring-primary focus:border-primary" />
            </div>
            <div>
              <label className="text-sm text-muted-foreground block mb-1.5">Password</label>
              <Input type="password" placeholder="••••••••" className="bg-muted/50 border-border focus:ring-primary focus:border-primary" />
            </div>
            <GlowButton className="w-full" type="submit">Sign In</GlowButton>
          </form>
