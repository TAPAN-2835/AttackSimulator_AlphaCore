...
class EventType(str, enum.Enum):
    ...
    WHATSAPP_LINK_GENERATED = "WHATSAPP_LINK_GENERATED"
    TELEGRAM_SENT = "TELEGRAM_SENT"
    INSTAGRAM_SENT = "INSTAGRAM_SENT"
    LINKEDIN_SENT = "LINKEDIN_SENT"
    TELEGRAM_LINK_GENERATED = "TELEGRAM_LINK_GENERATED"
    INSTAGRAM_LINK_GENERATED = "INSTAGRAM_LINK_GENERATED"
    LINKEDIN_LINK_GENERATED = "LINKEDIN_LINK_GENERATED"
